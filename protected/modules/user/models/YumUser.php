...
class YumUser extends YumActiveRecord
{
	...
	public function rules()
	{
		return array(
			...
			array('username+domainID', 'application.extensions.uniqueMultiColumnValidator', 'message' => Yii::t("UserModule.user", "Blah ... This user's name already exists.")),
			...
			array('domainID,createtime, lastvisit, superuser, status', 'numerical', 'integerOnly'=>true),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'domainID'=>Yii::t('UserModule.user', 'domain'),
	...
	{
		// let's set the domain for this record ...
    	$this->setAttribute( 'domainID', Yii::app()->controller->domain->id );
