...
class BizcardController extends MController
{
	/**
	...
	{
		$model=new Bizcard('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bizcard']))
			$model->attributes=$_GET['Bizcard'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Bizcard::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bizcard-form')
		{
